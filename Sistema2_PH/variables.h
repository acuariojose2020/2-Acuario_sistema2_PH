...
const uint8_t GPIOPIN[6] =  {D0,D6,D7,D8,D4};  // D4 es la bomba de relleno  D0 es el CO2

#define      Relay_D6        D6   // (D6) 
#define      Relay_D7        D7   // (D7) 
#define      Relay_D8        D8   // (D8) 

#define      Relay_D0_CO2          D0     
#define      Relay_D4_bomba        D4    

#define      Input_D3_boya_alta         D3     
...
//float     h = 0 ;
//float     pa = 0;
boolean   estados[5]; //estados de los relés //se añaden los D0 y D4 calentador y ventilador
int       Num_reles=4;
int       i,j,k;
